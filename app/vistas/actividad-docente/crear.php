...
<head>
    ...
    <title>Crear Actividad - Gestión Docente</title>
...
<body class="home-body">
    ...
    <main class="main-container content-align-top">
        ...
        <div class="breadcrumb" style="color: var(--text-gray); font-size: 0.85rem; margin-bottom: 1rem;">
            <a href="?accion=listar" style="color: var(--text-gray); text-decoration: none;">Actividades</a> / <span style="color: var(--c-primary-main); font-weight: 600;">Registrar Nueva Actividad</span>
        </div>

        <header class="section-header">
            <div>
                <h1 class="page-title">Registrar Nueva Actividad</h1>
                <p class="page-subtitle">Ingrese los datos para la nueva actividad docente.</p>
            </div>
        </header>
                ...
                <div class="section-card">
                    <form method="POST" action="?accion=guardar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-input" id="horas" name="horas" placeholder="Ej: 40" min="1" required>
                        </div>
