...
<head>
    ...
    <title>Detalle de Actividad - Gestión Docente</title>
...
<body class="home-body">
    ...
    <main class="main-container content-align-top">
        ...
        <div class="breadcrumb" style="color: var(--text-gray); font-size: 0.85rem; margin-bottom: 1rem;">
            <a href="listado.html" style="color: var(--text-gray); text-decoration: none;">Actividades</a> / <span style="color: var(--c-primary-main); font-weight: 600;">Detalles</span>
        </div>

        <header class="section-header">
            <div>
                <h1 class="page-title">Detalle de la Actividad</h1>
                <p class="page-subtitle">InformaciÃ³n completa de la actividad registrada.</p>
            </div>
            <div>
                <a href="listado.html" class="btn-cancel">Volver al listado</a>
            </div>
        </header>
        ...
        <div class="details-layout" style="grid-template-columns: 1fr; max-width: 800px; margin: 0 auto; width: 100%;">
            <div class="form-section">
                <div class="section-card">
                    <div id="contenedorDetalle" style="text-align: center; color: var(--text-gray); padding: 2rem 0;">
    ...
    <script src="../../../public/js/actividad-docente/ActividadModel.js"></script>
    <script src="../../../public/js/actividad-docente/ActividadView.js"></script>
    <script src="../../../public/js/actividad-docente/ActividadControlador.js"></script>
</body>
</html>
