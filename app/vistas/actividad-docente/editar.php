...
<head>
    ...
    <title>Editar Actividad - Gestión Docente</title>
...
<body class="home-body">
    ...
    <main class="main-container content-align-top">
        ...
        <div class="breadcrumb" style="color: var(--text-gray); font-size: 0.85rem; margin-bottom: 1rem;">
            <a href="?accion=listar" style="color: var(--text-gray); text-decoration: none;">Actividades</a> / <span style="color: var(--c-primary-main); font-weight: 600;">Editar Actividad</span>
        </div>

        <header class="section-header">
            <div>
                <h1 class="page-title">Editar Actividad</h1>
                <p class="page-subtitle">Actualice los datos de la actividad docente.</p>
            </div>
        </header>
                ...
                <div class="section-card">
                    <form method="POST" action="?accion=actualizar&id=<?= $actividad['id_actividad'] ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-input" id="horas" name="horas" value="<?= htmlspecialchars($actividad['horas']) ?>" min="1" required>
                        </div>

                        <div class="grid-2">
                            <div class="form-group">
                                <label for="fechaInicio">Fecha de Inicio</label>
                                <input type="date" class="form-input" id="fechaInicio" name="fechaInicio" value="<?= htmlspecialchars($actividad['fecha_inicio']) ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="fechaFin">Fecha de Fin</label>
                                <input type="date" class="form-input" id="fechaFin" name="fechaFin" value="<?= htmlspecialchars($actividad['fecha_fin']) ?>" required>
                            </div>
                        </div>

                        <div class="form-actions-bar">
                            <a href="?accion=listar" class="btn-cancel">Cancelar</a>
