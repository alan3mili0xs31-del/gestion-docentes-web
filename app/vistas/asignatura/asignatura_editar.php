                ...
                <div class="section-card">
                    <form id="formEditarAsignatura">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="nombre" name="nombre" required placeholder="Ingrese el nombre de la asignatura" value="<?= htmlspecialchars($asignatura['nombre'] ?? '') ?>">
                        </div>
                        ...
                        <div class="grid-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" id="codigo" name="codigo" required placeholder="Ej: INF-144" value="<?= htmlspecialchars($asignatura['codigo'] ?? '') ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-input" id="semestre" name="semestre" required>
                                    <option value="" disabled selected>Seleccione el semestre...</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Primer")) echo "selected"; ?> value="Primer">Primer</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Segundo")) echo "selected"; ?> value="Segundo">Segundo</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Tercero")) echo "selected"; ?> value="Tercero">Tercero</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Cuarto")) echo "selected"; ?> value="Cuarto">Cuarto</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Quinto")) echo "selected"; ?> value="Quinto">Quinto</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Sexto")) echo "selected"; ?> value="Sexto">Sexto</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Septimo")) echo "selected"; ?> value="Septimo">Septimo</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Octavo")) echo "selected"; ?> value="Octavo">Octavo</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Noveno")) echo "selected"; ?> value="Noveno">Noveno</option>
                                        <option <?php if(htmlspecialchars($asignatura['semestre'] == "Decimo")) echo "selected"; ?> value="Decimo">Decimo</option>
                                </select>
                            </div>
                        ...
                        <div class="grid-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-input" id="creditos" name="creditos" min="1" max="10" required placeholder="Ingrese el número de creditos" value="<?= htmlspecialchars($asignatura['creditos'] ?? '') ?>">
                            </div>
