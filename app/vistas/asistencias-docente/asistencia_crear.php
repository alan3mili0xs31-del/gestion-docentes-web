...
?>
    ...
    <main class="main-container content-align-top">
        ...
        <div class="breadcrumb" style="color: var(--text-gray); font-size: 0.85rem; margin-bottom: 1rem;">
            <a href="/gestion-docentes-web/asistencias-docente" style="color: var(--text-gray); text-decoration: none;">Asistencias</a> / <span style="color: var(--c-primary-main); font-weight: 600;">Registrar Asistencia</span>
        </div>

        <header class="section-header">
            <div>
                <h1 class="page-title">Registrar Asistencia</h1>
                <p class="page-subtitle">Añade un nuevo registro de asistencia.</p>
            </div>
        </header>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input" id="id_asignatura" name="id_asignatura" required>
                                ...
                                <?php foreach ($asignaturas as $asignatura): ?>
                                    <option value="<?= htmlspecialchars($asignatura['id_asignatura']) ?>">
