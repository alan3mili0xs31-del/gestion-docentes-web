            ...
            <div class="form-section">
                <div class="section-card">
                    <form id="formEditarAsistencia">
                        <input type="hidden" id="asistenciaId" name="id_asistencia" value="<?= htmlspecialchars($asistencia['id_asistencia'] ?? '') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input" id="id_docente" name="id_docente" required>
                                ...
                                <?php foreach ($docentes as $docente): ?>
                                    <option value="<?= htmlspecialchars($docente['id_docente']) ?>" <?= (isset($asistencia['id_docente']) && $asistencia['id_docente'] == $docente['id_docente']) ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input" id="id_asignatura" name="id_asignatura" required>
                                ...
                                <?php foreach ($asignaturas as $asignatura): ?>
                                    <option value="<?= htmlspecialchars($asignatura['id_asignatura']) ?>" <?= (isset($asistencia['id_asignatura']) && $asistencia['id_asignatura'] == $asignatura['id_asignatura']) ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-input" id="fecha" name="fecha" value="<?= htmlspecialchars($asistencia['fecha'] ?? '') ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="estado">Estado</label>
                            <select class="form-input" id="estado" name="estado" required>
                                <option value="presente" <?= (isset($asistencia['estado']) && $asistencia['estado'] === 'presente') ? 'selected' : '' ?>>Presente</option>
                                <option value="ausente" <?= (isset($asistencia['estado']) && $asistencia['estado'] === 'ausente') ? 'selected' : '' ?>>Ausente</option>
                                <option value="atrasado" <?= (isset($asistencia['estado']) && $asistencia['estado'] === 'atrasado') ? 'selected' : '' ?>>Atrasado</option>
                            </select>
                        </div>

                        <div class="form-actions-bar">
                            <a href="/gestion-docentes-web/asistencias-docente" class="btn-cancel">Cancelar</a>
