...
?>
    ...
    <main class="main-container content-align-top">
        ...
        <div class="breadcrumb" style="color: var(--text-gray); font-size: 0.85rem; margin-bottom: 1rem;">
            <a href="/gestion-docentes-web/docentes" style="color: var(--text-gray); text-decoration: none;">Docentes</a> / <span style="color: var(--c-primary-main); font-weight: 600;">Nuevo Docente</span>
        </div>
                ...
                <div class="section-card">
                    <form id="formCrear">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="cedula" name="cedula" placeholder="Ingresa la cedula" required>
                        </div>

                        <div class="grid-2">
                            <div class="form-group">
                                <label for="primer_nombre">Primer nombre</label>
                                <input type="text" class="form-input" id="primer_nombre" name="primer_nombre" required placeholder="Ingresa el primer nombre">
                            </div>
                            <div class="form-group">
                                <label for="segundo_nombre">Segundo nombre <span style="color: #9CA3AF; font-weight: 400;">(Opcional)</span></label>
                                <input type="text" class="form-input" id="segundo_nombre" name="segundo_nombre" placeholder="Ingresa el segundo nombre">
                            </div>
                        </div>
                        ...
                        <div class="grid-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" id="primer_apellido" name="primer_apellido" required placeholder="Ingresa el primer apellido">
                            </div>
                            <div class="form-group">
                                <label for="segundo_apellido">Segundo apellido <span style="color: #9CA3AF; font-weight: 400;">(Opcional)</span></label>
                                <input type="text" class="form-input" id="segundo_apellido" name="segundo_apellido" placeholder="Ingresa el segundo apellido">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="especialidad">Especialidad</label>
                            <input type="text" class="form-input" id="especialidad" name="especialidad" placeholder="Ingresa la especialidad" required>
                        </div>
