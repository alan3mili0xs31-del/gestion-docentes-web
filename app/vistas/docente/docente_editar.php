                    ...
                    <form id="formEditar">
                        ...
                        <div class="grid-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" id="nombres" name="nombres" value="<?= htmlspecialchars(trim(($docente['primer_nombre'] ?? '') . ' ' . ($docente['segundo_nombre'] ?? ''))) ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="apellidos">Apellidos</label>
                                <input type="text" class="form-input" id="apellidos" name="apellidos" value="<?= htmlspecialchars(trim(($docente['primer_apellido'] ?? '') . ' ' . ($docente['segundo_apellido'] ?? ''))) ?>" required>
                            </div>
                        </div>
