...
<main class="main-container">
    ...
    <form method="POST" action="<?= BASE_URL ?>/perfil/actualizar" style="max-width: 1000px; margin: 0 auto 3rem auto; position: relative; top: -1.5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem; align-items: start;">
